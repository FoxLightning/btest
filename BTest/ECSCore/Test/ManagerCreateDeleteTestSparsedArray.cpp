...
int main()
{
    ...
    {
        const auto managerOne =
            entity
                ->CreateManager<ECSCore::TObjectManager<TestObjectOne, FunLib::TSparseArrayContainer<TestObjectOne>>>();
        const auto managerTwo =
            entity
                ->CreateManager<ECSCore::TObjectManager<TestObjectTwo, FunLib::TSparseArrayContainer<TestObjectTwo>>>();
        const auto managerThree = entity->CreateManager<
            ECSCore::TObjectManager<TestObjectThree, FunLib::TSparseArrayContainer<TestObjectThree>>>();
    ...
    if (const auto objectCount =
            entityConst
                ->GetManager<ECSCore::TObjectManager<TestObjectOne, FunLib::TSparseArrayContainer<TestObjectOne>>>()
                .lock()
                ->GetObjectCount();
    ...
    if (const auto objectCount =
            entityConst
                ->GetManager<ECSCore::TObjectManager<TestObjectTwo, FunLib::TSparseArrayContainer<TestObjectTwo>>>()
                .lock()
                ->GetObjectCount();
    ...
    if (const auto objectCount =
            entityConst
                ->GetManager<ECSCore::TObjectManager<TestObjectThree, FunLib::TSparseArrayContainer<TestObjectThree>>>()
                .lock()
                ->GetObjectCount();
    ...
    const auto managerMutable =
        entity->GetManager<ECSCore::TObjectManager<TestObjectTwo, FunLib::TSparseArrayContainer<TestObjectTwo>>>();
